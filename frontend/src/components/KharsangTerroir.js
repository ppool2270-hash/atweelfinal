...
export default function KharsangTerroir({ onNavigateTab, onOpenLeadForm }) {
  return (
    <div className="bg-tata-bg-light text-tata-dark py-16 sm:py-24" id="sourcing-origin" data-testid="kharsang-terroir-page">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="bg-tata-dark text-tata-bg-light rounded-3xl p-8 sm:p-14 border-2 border-white/20 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-6 text-xs font-mono text-tata-dark border-t border-white/20">
              <span className="flex items-center gap-1.5">
                <MapPin className="w-4 h-4 text-tata-grey" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 bg-white p-8 sm:p-10 rounded-3xl border-2 border-white/20 shadow-xl">
            <div className="inline-block px-3 py-1 rounded bg-tata-dark text-tata-blue-light font-mono text-xs font-bold uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-tata-grey-light">
              <div className="p-4 bg-tata-bg-light rounded-2xl border border-tata-grey-light">
                <div className="flex items-center gap-2 font-bold text-tata-dark text-xs font-mono uppercase mb-1">
                  <CloudRain className="w-4 h-4 text-tata-grey" />
                  <span>Eastern Himalayan Mist</span>
                </div>
                <p className="text-xs text-tata-grey leading-relaxed">
              ...
              <div className="p-4 bg-tata-bg-light rounded-2xl border border-tata-grey-light">
                <div className="flex items-center gap-2 font-bold text-tata-dark text-xs font-mono uppercase mb-1">
                  <Thermometer className="w-4 h-4 text-tata-grey" />
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-tata-dark p-6 rounded-3xl border-2 border-tata-dark/20 text-tata-bg-light shadow-2xl space-y-6">
              ...
              <div className="relative rounded-2xl overflow-hidden h-64 border border-white/20">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-tata-dark via-transparent to-transparent" />
                <span className="absolute bottom-3 left-3 bg-tata-dark/80 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-mono text-tata-blue-light border border-white/20">
              ...
              <div className="space-y-3 font-mono text-xs">
                <div className="flex items-center justify-between pb-2 border-b border-white/10">
                  <span className="text-tata-grey">Total Organic Acreage:</span>
                  <strong className="text-tata-grey font-bold">1,200 Bigha (~400 Acres)</strong>
                </div>
                <div className="flex items-center justify-between pb-2 border-b border-white/10">
                  <span className="text-tata-grey">Factory Footprint:</span>
                  <strong className="text-tata-dark font-bold">72,000 Sq Ft Plant</strong>
                </div>
                <div className="flex items-center justify-between pb-2 border-b border-white/10">
                  <span className="text-tata-grey">Dryer Target Moisture:</span>
                  <strong className="text-tata-grey font-bold">3.00% ±0.05% Fixed</strong>
                </div>
                <div className="flex items-center justify-between pb-2 border-b border-white/10">
                  <span className="text-tata-grey">Pesticide Screening:</span>
                  <strong className="text-tata-grey font-bold">Eurofins 500+ Screen Pass</strong>
                </div>
              </div>
        ...
        <div className="bg-tata-dark text-tata-bg-light rounded-3xl p-8 sm:p-12 border-2 border-white/20 shadow-xl space-y-8">
          <div className="max-w-3xl space-y-3">
            <span className="text-xs font-bold text-tata-dark uppercase tracking-[0.25em] block font-mono">
              Sensory Profile &amp; Liquor Characteristics
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-white">
              The Robust Cup of Kharsang High-Altitude Tea
            </h2>
            <p className="text-tata-grey text-sm leading-relaxed font-sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="p-6 bg-tata-dark rounded-2xl border border-white/20 space-y-2">
              <span className="text-tata-dark font-serif text-2xl font-bold block">Aroma</span>
              <h4 className="font-serif text-lg font-bold text-white">Honeyed Muscatel &amp; Wild Orchid</h4>
              <p className="text-xs text-tata-grey">Lifted floral top notes from morning mist evaporation during withering.</p>
            </div>

            <div className="p-6 bg-tata-dark rounded-2xl border border-white/20 space-y-2">
              <span className="text-tata-dark font-serif text-2xl font-bold block">Liquor</span>
              <h4 className="font-serif text-lg font-bold text-white">Luminous Copper &amp; Golden Amber</h4>
              <p className="text-xs text-tata-grey">Bright, crystal-clear infusion with abundant golden tip leaf float.</p>
            </div>

            <div className="p-6 bg-tata-dark rounded-2xl border border-white/20 space-y-2">
              <span className="text-tata-dark font-serif text-2xl font-bold block">Body</span>
              <h4 className="font-serif text-lg font-bold text-white">Rich Malt &amp; Velvety Mouthfeel</h4>
              <p className="text-xs text-tata-grey">Robust structure ideal for standalone tasting or specialty milk blends.</p>
            </div>
          </div>
